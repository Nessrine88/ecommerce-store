...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 text-white flex-col gap-0.5 p-4 pb-0 group-data-[swipe-axis=y]/drawer-popup:text-center md:gap-0.5 md:text-left",
        className
      )}
      {...props}
    />
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("text-sm text-balance text-white", className)}
      {...props}
    />
  )
}
